...
[compare changes](https://github.com/nrjdalal/rate-my-ott/compare/v0.0.5...v0.0.6)

### 🚀 Enhancements

- Say why a title has no score, on the API and in the popup ([#12](https://github.com/nrjdalal/rate-my-ott/pull/12))
